...
@section('content')
    <div class="mx-auto">
        <div class="px-4 sm:px-8 md:px-12 bg-white rounded-lg mt-7 pt-2">
            ...
            @endif
            <div class="my-3">
                <h2 class="text-lg font-semibold">Edit Dropshipper</h2>
            </div>
            <form action="{{ route('admin.dropshippers.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <x-input name="phone" value="{{ $user->vendor->phone ?? '' }}" />
                    </div>
                    <div class="flex flex-col gap-2">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <x-input name="store_url" value="{{ $user->vendor->store_url ?? '' }}" />
                    </div>
                    <div class="flex flex-col gap-2">

            ...
            <div class="border p-4 rounded-lg bg-gray-50">
                ...
                <table class="text-sm w-full ">
                    ...
                    <tr>
                        ...
                        <td class="text-right ">
                            <span class="inline-flex rounded-md bg-green-200 px-4 text-xs font-semibold leading-5">{{ ucfirst($order->status) }}</span>
                        </td>
                    </tr>
                    <tr>
        ...
        <div class="mt-4">
            <table class="min-w-full divide-y divide-gray-200 ">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="">
                        <td class="px-4 py-3.5 text-sm font-normal text-gray-700 border">#{{ $item->product->sku }}</td>
                        ...
                        <td class="px-4 py-3.5 text-sm font-normal text-gray-700 border">RS.{{ $item->price }}</td>
                        <td class="px-4 py-3.5 text-sm font-normal text-gray-700 border">RS.{{ $item->qty * $item->price }}</td>
                    </tr>
                    @endforeach
                    <tr>
                    ...
                    <tr>
                        <td colspan="4" class="px-4 py-3.5 text-sm font-bold text-gray-400 text-right">Delivery Charges</td>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3.5 text-sm font-normal text-gray-700">RS.{{ $order->tax + $order->shipping_cost +$order->total }}</td>
                    </tr>
                </tbody>
            </table>

        ...
        <div class="flex items-center justify-between">
            <div class="flex space-x-2">
                <div>
                    ...
                    <input type="date" name="start_date" id="" class="p-1 rounded-md" value="{{ date('Y-m-d') }}">
                </div>
                <div>
                    <input type="date" name="end_date" id="" class="p-1 rounded-md" value="{{ date('Y-m-d') }}">
                </div>
                <div>
                    <input type="text" name="sku" id="" class="p-1 rounded-md" placeholder="Enter SKU if any">
                </div>
            </div>
            <div>
                    ...
                    <div class="overflow-hidden border border-gray-200 md:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th scope="col" class="px-4 py-3.5 text-left text-sm font-normal text-gray-700"><input type="checkbox" name="orderidsall"></th>
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                ...
                                <tr>
                                    <td class="whitespace-nowrap px-4 py-4"><input type="checkbox" name="checkorderIds" value="{{ $item->id }}" class="order-id"></td>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-4 text-sm text-gray-700 flex items-center space-x-2">
                                        ...
                                        <a href="{{ $item->track_data['invoice_url'] }}" target="__blank" aria-label="Edit Order {{ $item->id }}">
...
<script type="module">
    ...
    $('#downloadstock').on('click', function() {
        axios({
            ...
            var blob = new Blob([csvmaker(response.data.rows)], { type: 'text/csv' });

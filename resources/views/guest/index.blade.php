        ...
        <div class="flex-1">
          ...
          <div class='flex flex-col gap-6'>
            <p class="text-gray-800 text-justify">
              Welcome to Zee Dropshipping, Pakistan's premier platform for seamless and efficient Dropshipping. We are dedicated to empowering entrepreneurs by providing a comprehensive solution that caters to all your e-commerce needs. At Zee Dropshipping, we understand the fast-paced nature of online business, and our services are designed to help you thrive in this competitive market.
<br/></br>We offer <span class="font-bold">same-day dispatch </span>, ensuring that your customers receive their orders quickly and reliably. Our <span class="font-bold">wide range of tested products</span> guarantees that you can offer quality items with confidence. With our <span class="font-bold">twice-a-week payment system</span>, you can manage your cash flow more effectively, allowing you to reinvest in your business.
<br/></br>Our commitment to quality is reflected in our <span class="font-bold">Product Quality Assurance</span> program, and our <span class="font-bold">Dedicated Dropshipper Support</span> team is always on hand to assist you with any challenges. We also provide <span class="font-bold">automated order processing</span> and the flexibility of an <span class="font-bold">optional order confirmation facility</span>. Additionally, our network of <span class="font-bold">multiple logistic partners</span> ensures <span class="font-bold">nationwide delivery</span>, covering every corner of Pakistan.
<br/></br>At Zee Dropshipping, we are more than just a service—we are your partner in success. Join us today and take your business to new heights!
        ...
        <div class="">
          ...
          <div class='flex flex-col gap-6'>
              <ul class="list-decimal">
                ...
                <li><span class="font-bold">Shopify Integration:</span> Introduced a one-click Shopify integration, simplifying the dropshipping process for store owners.</li>
                <li><span class="font-bold">International Trip:</span> Launched a highly successful incentive program, offering a trip to Dubai for top achievers.</li>
                <li><span class="font-bold">Continuous Growth:</span> Expanded our product range and enhanced our platform, making Zee Dropshipping a leader in the industry.</li>
              </ul>
          </div>
        </div>
        <div class="">
    ...
    <div class='bg-gray-100 py-11'>
      ...
      <p class='text-center font-bold text-2xl text-blue-950 py-10'>Why Choose Zee Dropshipping ?</p>

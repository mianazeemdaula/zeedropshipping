...
<div class="p-4">
    <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2">
        <div class="space-y-4">
            ...
            <div class="border p-2 max-w-fit">
                ...
                <div class="space-y-2">
                    ...
                    <div class="grid gap-4">
                        <div>
                            ...
                            <input type="text" name="name" id="name" class="w-full p-1 border" required>
                        </div>
                        <div>
                            <label for="email">Email</label>
                            <input type="email" name="email" id="email" class="w-full p-1 border" required>
                        </div>
                        <div class="col-span-2">
                            <label for="subject">Subject</label>
                            <input type="text" name="subject" id="subject" class="w-full p-1 border" required>
                        </div>
                        <div class="col-span-2">
                            <label for="message">Message</label>
                            <textarea name="message" id="message" class="w-full p-2 border" required></textarea>
                        </div>
                        <div class="col-span-2">
